...
def extract_secrets(page_content):
    ...
    'Firebase Auth Domain': r'authDomain\s*:\s*"[a-zA-Z0-9.-]+\.firebaseapp\.com"',
    'Firebase Database URL': r'databaseURL\s*:\s*"https://[a-zA-Z0-9.-]+\.firebaseio\.com"',
    'Firebase Project ID': r'projectId\s*:\s*"[a-zA-Z0-9-]+"',
